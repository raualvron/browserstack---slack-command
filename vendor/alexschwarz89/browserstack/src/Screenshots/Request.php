...
class Request
{
     ...
     * @param null $device
     */
    public function addBrowser($os, $os_version, $browser, $browser_version, $device)
    {
        $this->browsers[] = array(
            'os' => $os,
     ...
     * @return Request
     */
    public static function buildRequest($url, $os, $os_version, $browser, $browser_version, $device)
    {
        $request = new self;
        $request->url = $url;
        $request->addBrowser($os, $os_version, $browser, $browser_version, $device);
